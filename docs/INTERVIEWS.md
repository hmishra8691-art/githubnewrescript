...
Migrations through **0036** must be applied. 0035 widens `interview_questions.kind`,
...
so the window runs in hours or days from the last activity. Both are additive;
