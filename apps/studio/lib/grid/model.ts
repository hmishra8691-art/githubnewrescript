...
export const GRID_COLUMNS: readonly GridColumn[] = [
  ...
  { id: "options", label: "Options", width: 240, minWidth: 140, sortable: true, defaultVisible: true, description: "Answer options, rows × columns, or range" },
  ...
  { id: "validation", label: "Validation", width: 160, minWidth: 100, sortable: true, defaultVisible: false, description: "Required and validation rules" },
