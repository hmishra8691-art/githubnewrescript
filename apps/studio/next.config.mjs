...
const nextConfig = {
  transpilePackages: ["@rescript/schema", "@rescript/engine", "@rescript/designs", "@rescript/exporters", "@rescript/templates", "@rescript/analytics", "@rescript/renderer", "@rescript/mail", "@rescript/ai"],
