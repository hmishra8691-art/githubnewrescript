...
Three things went wrong at once, and the deployment target decides which one
you hit first:
...
big a recording should be: 720p/30fps, 1.2 Mbps video, 96 kbps audio, a
5-second timeslice, and a 10-minute auto-stop. Five minutes is **~49 MB**; ten
is ~97 MB. The chunk array is released once the take is assembled instead of
being held alongside it.
...
accept 25 MB and a 49 MB video is not something to hand them; doing it in the
